...
\ifdefined\showCRDTProject
{Collaborative Text Editor}
{Distributed Systems, Final Project}
{April 2026 - May 2026}
{}
\resumeItemListStart
\item[$\bullet$] Implemented a version of the YATA Conflict-free Replicated Data Type to implement collaborative text editing over peer-to-peer connections.
\item[$\bullet$] Designed a peer-to-peer broadcasting protocol that enables real-time collaboration over sparse connected peer graphs.
\resumeItemListEnd
\fi
