...
\geometry{left=0.85cm, top=0.6cm, right=0.85cm, bottom=0.2cm}
...
\newcommand{\resumeSubHeadingListStart}{\begin{itemize}[leftmargin=*,labelsep=0mm,topsep=0pt,parsep=0pt,partopsep=0pt,itemsep=1.25mm]}
\newcommand{\resumeItemListStart}{\begin{justify}\begin{itemize}[leftmargin=3ex, rightmargin=2ex, noitemsep,labelsep=1.2mm,itemsep=0mm,topsep=0.25mm,parsep=0pt]\small}
